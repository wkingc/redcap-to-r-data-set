...
This presentation will use the R programming language and assume the user is using Rstudio to compile their R markdown files into HTML [@Rlang2019; @Rstudio].  All of the files used in this presentation can be downloaded from the Git repository <code>git clone <span>https</span>://git.waderstats.com/redcap_to_r_data_set/</code>.
